# -*- coding: utf-8 -*-
"""NLP_HW4_NCKU_F74102022

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1OPtOC42Wc2SePJu49fa2uyrGZNA19Cnc
...
EMBED_MODEL = "princeton-nlp/sup-simcse-bert-base-uncased"
...
system_prompt = (
    "Use the given context to answer the question. "
    "Use three sentence maximum and keep the answer concise. "
    "If the answer is numerical, please print the number with unit. "
    "Repeat the complete context first then answer the question. "
    "Context: {context}"
)
...
system_prompt = (
    "Use the given context to answer the question. "
    "Using format : Context : [context], Answer: [answer]."
